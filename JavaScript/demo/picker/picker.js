...
(function (window, document, Math) {
    ...
    Picker.prototype = {
        ...
        FillData: function () {
            ...
            modalParent.className = "zxMask";

            var picker_list = '<div class="zxSelect showPicker">' +
            ...
            setTimeout(function () {
                document.querySelector('.zxSelect').style.height = '245px';
            }, 0);
        },
        ...
        HidePicker : function(){
            var self = this;
            document.querySelector('.zxSelect').style.height = '0';
            self.remove_EventListen();
            setTimeout(function () {
                var modalBox = document.querySelector('.zxMsak');
                document.body.removeChild( modalBox );
                self.destroy();//销毁变量
            }, 200);
        },
